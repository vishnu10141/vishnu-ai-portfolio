...
export default function Contact() {
  return (
    <section id="contact" className="w-full pt-32 pb-24">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-20">
        ...
        {/* Right Column (Form) */}
        <div className="rounded-2xl border border-white/[0.08] bg-[#020611]/80 backdrop-blur-xl p-8 relative overflow-hidden">
